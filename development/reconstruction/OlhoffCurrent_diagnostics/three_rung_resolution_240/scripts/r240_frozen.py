#!/usr/bin/env python3
"""r240_frozen -- the FROZEN two-branch rule with STAGE-LOCAL windows, offline.

Byte-for-byte the two_rung_architecture/scripts/tr_frozen.py module (itself a re-use
of move_ladder_necessity/scripts/ml_frozen.py), extended to the exact
stage-reset semantics of +impl/architecture/+olh/+move/exhaustion.m so that the
rule can be replayed inside every stage, not only stage 1.
