% RUN_SS_N1  Section 3.1 / Fig. 3a: simply supported beam, max omega_1 -> 174.7 (bimodal)
%
%   Olhoff & Du (2014), "Structural Topology Optimization with Respect to
%   Eigenfrequencies of Vibration", CISM 2014.
%
%   Usage:  res = run_ss_n1;                     % defaults from olhoff2014_case
%           res = run_ss_n1(struct('nelx',240,'nely',30));
%
...
function res = run_ss_n1(overrides)
if nargin < 1, overrides = struct(); end
res = run_olhoff_case('ss_n1', overrides);
end
