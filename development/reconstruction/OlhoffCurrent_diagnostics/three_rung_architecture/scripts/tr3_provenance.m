function P = tr3_provenance(tag)
%TR3_PROVENANCE  Phase 0 provenance / evidence gate for the three-rung architecture
...
P = struct();
P.study      = 'three_rung_architecture';
P.tag        = tag;
...
studies = {'two_branch_controller_validation','move_ladder_necessity', ...
           'two_rung_architecture','two_branch_maturity_240'};
...
P.verdict = 'THREE_RUNG_EVIDENCE_GATE_PASS';
if ~P.gateOk, P.verdict = 'THREE_RUNG_EVIDENCE_GATE_FAIL'; end
