function [K, M] = assemble_KM_exact(rho, Ke_star_l, Me_star_l, iK, jK, nDof, penal, mass_mode, mass_q)
...
rho = rho(:);
Ee  = rho .^ penal;                            % K_e = rho^p Ke*   (Olhoff2014 Eq. 5)
re  = mass_interp(rho, mass_mode, mass_q);     % M_e = m(rho) Me*
