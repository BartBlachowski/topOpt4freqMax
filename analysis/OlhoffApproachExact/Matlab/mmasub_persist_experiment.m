...
%
function [xmma,ymma,zmma,lam,xsi,eta,mu,zet,s,low,upp,asyinfo] = ...
mmasub_persist_experiment(m,n,iter,xval,xmin,xmax,xold1,xold2, ...
f0val,df0dx,fval,dfdx,low,upp,a0,a,c,d,asyinit)
%
...
move = 1.0;
albefa = 0.1;
if nargin < 19 || isempty(asyinit), asyinit = 0.01; end
asyincr = 1.2;
asydecr = 0.7;
eeen = ones(n,1);
eeem = ones(m,1);
...
asyinfo.factor = factor;
asyinfo.expand = (factor > 1);
asyinfo.contract = (factor < 1);
asyinfo.width = upp - low;
