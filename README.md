...
The first approach uses classical double-loop approach proposed by Du and Olhoff (2007). The second one uses two level static approximation proposed by Yuksal and Yilmaz (2025). Finally, the third approach is newly proposed one-level quasi-static approachimation. 
