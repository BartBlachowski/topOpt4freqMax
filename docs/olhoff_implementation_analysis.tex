...
profile, but runtime, convergence, memory, and scaling require accepted
instrumented evidence. Any retained comparison must name `OlhoffApproach' as a
local implementation and must not be interpreted as canonical-method evidence.
