...
try:
    ...
    from examples.fromPaper.Olhoff.cases import PAPER_TARGETS, case_config
    from examples.fromPaper.Olhoff.solver import run_optimization
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--snapshot-every", type=int, default=0, help="Snapshot frequency (0 disables)")
    return parser
