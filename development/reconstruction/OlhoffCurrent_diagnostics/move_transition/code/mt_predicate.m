function E = mt_predicate(P, cand)
%MT_PREDICATE  Evaluate an admission rule on a recorded trajectory.
%
%   E = MT_PREDICATE(P, cand) returns every component of the predicate at every
