...
table is carried forward in this planning document.  Any separate
reviewer-facing table or figure is admissible only after its provenance is
verified against the production campaign and its caption states the local
implementation scope.  This policy removes the unsupported empirical chain
without requesting a replacement experiment.
